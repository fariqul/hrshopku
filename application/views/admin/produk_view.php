            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <a href="<?= site_url('admin/tambahproduk') ?>" class="btn btn-sm btn-primary shadow-sm float-right pull-right">
                                    ...
                                    <table class="table table-bordered table-striped" id="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="<?= base_url('assets/foto/'.$item['fotoproduk']); ?>" width="100px"></td>
                                                <td><?= $item['stokproduk']; ?></td>
                                                <td><?= $item['beratproduk']; ?> g</td>
                                                <td>
                                                    <a href="<?= site_url('admin/ubahproduk/'.$item['idproduk']); ?>" class="btn btn-warning">Ubah</a>
                                                    <a href="<?= site_url('admin/hapusproduk/'.$item['idproduk']); ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus data?')">Hapus</a>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
