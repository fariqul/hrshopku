                ...
                <div class="container-fluid">
                    <div id="page-inner">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <a href="<?= site_url('admin/tambahkategori'); ?>" class="btn btn-sm btn-primary shadow-sm float-right pull-right">
                                            ...
                                            <tbody>
                                                ...
                                                <?php foreach ($kategori as $data) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?= site_url('admin/ubahkategori/'.$data['id_kategori']); ?>" class="btn btn-warning btn-sm">Ubah</a>
                                                            <a href="<?= site_url('admin/hapuskategori/'.$data['id_kategori']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data ?')">Hapus</a>
                                                        </td>
                                                    </tr>
                                                    <?php $nomor++; ?>
                                                <?php } ?>
